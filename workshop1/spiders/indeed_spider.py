...
class IndeedCrawlSpider(CrawlSpider):
    ...
    start_urls = [
        'https://uk.indeed.com/Data-Scientist-jobs-in-London']
    ...
    rules = (
        ...
        Rule(
            LinkExtractor(
                allow=r'/jobs\?q=Data\+Scientist&l=London&start=\d+'  # ! \d+ means that any number will be there
...
# process.crawl(IndeedCrawlSpider)
# process.start()
